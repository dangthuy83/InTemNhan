...
| T-002 | `MauIn/Editor` đổi được mẫu in mặc định nhất quán sau khi lưu; print/preview vẫn hiển thị tên trường khi field value rỗng nếu đã bật hiện tên trường | Completed | `2026-07-15`, `dotnet build` exit code `0`, `0` warnings, `0` errors |
