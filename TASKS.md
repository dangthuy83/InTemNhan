...
|---|---|---|
| `dotnet restore` | Unverified | Không chạy trong documentation-remediation session |
| `dotnet build` | Unverified | Không chạy trong documentation-remediation session |
